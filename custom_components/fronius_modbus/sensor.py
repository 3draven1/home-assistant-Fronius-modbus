...
ATTRIBUTION = "Fronius Modbus Data"
...
SENSOR_TYPES = {
    ...
    'dc_current1': ['inverter', False, '1_DCA', 'DC Current String 1', 'A', False, 'mdi:solar-power'],
    'dc_voltage1': ['inverter', False, '1_DCV', 'DC Voltage String 1', 'V', False, 'mdi:solar-power'],
    'dc_power1': ['inverter', True, '1_DCW', 'DC Power String 1', 'W', 'power', 'mdi:solar-power'],
    'dc_current2': ['inverter', False, '2_DCA', 'DC Current String 2', 'A', False, 'mdi:solar-power'],
    'dc_voltage2': ['inverter', False, '2_DCV', 'DC Voltage String 2', 'V', False, 'mdi:solar-power'],
    'dc_power2': ['inverter', True, '2_DCW', 'DC Power String 2', 'W', 'power', 'mdi:solar-power'],
